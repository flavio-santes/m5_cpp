...
enum StatusCode PktConnAck::authenticationMethod(const uint8_t *data,
                                                 uint16_t size)
{
...
enum StatusCode PktConnAck::authenticationData(const uint8_t *data,
                                               uint16_t size)
{
...
enum StatusCode PktConnAck::responseInformation(const uint8_t *data,
                                                uint16_t size)
{
