...
public:
    ...
    bool cleanStart(void) const
    {
        return this->_cleanStart;
    }
    void cleanStart(bool cleanStart);

    const ByteArray &clientId(void) const
    {
        return _clientId;
    }
    ...
    const ByteArray &willTopic(void) const
    {
        return _willTopic;
    }
    const ByteArray &willMsg(void) const
    {
        return _willMsg;
    }
    ...
    bool willRetain(void) const
    {
        return this->_willRetain;
    }
    void willRetain(bool willRetain);

    enum PktQoS willQoS(void) const
    {
        return Packet::QoS();
    }
    enum StatusCode willQoS(enum PktQoS qos)
    {
        return Packet::QoS(qos);
    }

    const ByteArray &userName(void) const
    {
        return _userName;
    }
    ...
    const ByteArray &password(void) const
    {
        return _password;
    }
