...
int test(void)
{
    ...
    remLen = 10 + 1 + 2 + strlen(clientId) + 2 + strlen(willTopic) + 2 +
             strlen(willMsg) + 2 + strlen(userName) + 2 + strlen(password);
    ...
    if (str.size() != strlen(clientId) ||
        memcmp(str.data(), clientId, strlen(clientId)) != 0) {
    ...
    if (str.size() != strlen(willTopic) ||
        memcmp(str.data(), willTopic, strlen(willTopic)) != 0) {
    ...
    if (str.size() != strlen(willMsg) ||
        memcmp(str.data(), willMsg, strlen(willMsg)) != 0) {
    ...
    if (str.size() != strlen(userName) ||
        memcmp(str.data(), userName, strlen(userName)) != 0) {
    ...
    if (str.size() != strlen(password) ||
        memcmp(str.data(), password, strlen(password)) != 0) {
